  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-2xl h-full min-h-screen flex items-center justify-center ">
        {/* <!-- Modal content --> */}
        <div className="relative  p-8 bg-white w-full flex flex-col gap-5 max-w-[38.75rem] min-h-[22.95rem]">
          <p className="text-2xl font-medium">Add a new image</p>
          <form
          ...
          >
            ...
            <div className="flex items-center gap-8 justify-end ">
              ...
              <button
                data-modal-toggle="defaultModal"
                type="submit"
                className="text-white px-6 h-[3.438rem] bg-[#0ea5e9] shadow-buttonShadow "
              >
